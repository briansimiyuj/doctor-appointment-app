...
const ConsultationType: React.FC = ()=>{
    ...
    const bookingContext = useContext(BookingContext),
          consultationType = bookingContext?.consultationType,
          setConsultationType = bookingContext?.setConsultationType         
    ...
    return(
        ...
        <div className="my-8">
            ...
            <div className="bg-white rounded-lg shadow p-4 pt-2 w-[300px]">
