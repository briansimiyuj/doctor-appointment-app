        ...
        if(latestAppointment.status === "pending"){
            ...
            return(
                ...
                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                    ...
                    <button className="px-4 py-2 bg-primary-btn text-white rounded-md hover:bg-primary-bg transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1 w-full sm:w-auto">
