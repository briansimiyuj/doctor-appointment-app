...
const BrowseFilesButton: React.FC = ()=>{
    ...
    return(
        ...
        <div className="text-center cursor-pointer mb-2">
            ...
            <button className="bg-secondary-btn text-white px-4 py-2 rounded-md hover:bg-blue-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">Browse Files</button>
