...
const EditModalFooter: React.FC = ()=>{
    ...
    return(
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 mt-6 pt-4 border-t border-gray-200">
            ...
            <button 
                type="submit" 
                className={`bg-blue-500 hover:bg-blue-600 text-white dark:text-white py-2 px-4 rounded-md transition-all duration-300 w-full sm:w-auto mt-2 sm:mt-0 ${canUpdate ? 'opacity-100 cursor-pointer' : 'opacity-50 cursor-not-allowed'}`}
                disabled={!canUpdate}
