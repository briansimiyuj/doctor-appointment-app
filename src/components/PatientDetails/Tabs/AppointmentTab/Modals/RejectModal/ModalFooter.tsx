...
const ModalFooter: React.FC = ()=>{
    ...
    return(
        ...
        <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-3">
            ...
            <button
                className={`bg-red-600 text-white dark:text-white  py-2 px-4 rounded-md transition-all duration-300 w-full sm:w-auto ${isValid ? "bg-red-700" : "cursor-not-allowed opacity-50"}`}
