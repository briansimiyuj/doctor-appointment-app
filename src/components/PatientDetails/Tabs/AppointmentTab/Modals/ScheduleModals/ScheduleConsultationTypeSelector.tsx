...
const ScheduleConsultationTypeSelector: React.FC = ()=>{

    const { consultationType, setConsultationType } = useScheduleAppointmentContext()
...
export default ScheduleConsultationTypeSelector