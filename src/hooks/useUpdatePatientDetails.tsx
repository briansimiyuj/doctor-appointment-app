...
export const useUpdatePatientDetails = () =>{
   ...
   const [showCancelModal, setShowCancelModal] = useState(false),
         ...
         [showViewNotesModal, setShowViewNotesModal] = useState(false),
         ...
         [showViewReasonsModal, setShowViewReasonsModal] = useState(false),
         ...
         [showReviewModal, setShowReviewModal] = useState(false),
         [appointmentToReview, setAppointmentToReview] = useState<AppointmentType | null>(() =>{
            const savedAppointment = localStorage.getItem('CurrentAppointmentToReview')
   ...
   const openReviewModal = (appointment: AppointmentType) =>{

      localStorage.setItem('CurrentAppointmentToReview', JSON.stringify(appointment))
   ...
   const closeReviewModal = () =>{
      ...
      localStorage.removeItem('CurrentAppointmentToReview')
   ...
   const openViewReviewModal = (appointment: AppointmentType) =>{
   
      localStorage.setItem('CurrentAppointmentToViewReviews', JSON.stringify(appointment))

      setShowViewReviewsModal(true)

      setAppointmentToViewReviews(appointment)
   
   }

   const closeViewReviewModal = () =>{

      localStorage.removeItem('CurrentAppointmentToViewReviews')

      setShowViewReviewsModal(false)

      setAppointmentToViewReviews(null)
